        ...
        <main class="shadow">
            <div id="midbar" class="row">
                ...
                <div id="rside" class="col-sm-8 col-md-9 col-lg-8 container-fluid">
                    <section>
                        <header>
                            <h1>Edit Events</h1> </header>
                        <br />
                        <main>
                            <div>
                                <br />
                                <div id="addEvent" class="container-fluid">
                                    <br />
                                    <input type="button" id="add" onclick="toggle_visibility('hiding');" value="Add Event" class="shadow btn btn-hide">
                                    <div id="hiding" class="container-fluid hidingdiv">
                                        <br />
                                        <form name="events" class="" method="post" action="inc/eventaddProcess.php">
                                            <table class="center table-responsive">
                                                <tr>
                                                    <td>Event Name:</td>
                                                    <td>
                                                        <input type="text" name="eventName" placeholder="Event Name"> </td>
                                                </tr>
                                                <tr>
                                                    <td>Date:</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>Type:</td>
                                                    <td>
                                                        <input type="text" name="type" placeholder="Type"> </td>
                                                </tr>
                                                <tr>
                                                    <td>Entry:</td>
                                                    <td>
                                                        <input type="text" name="entry" placeholder="Entry"> </td>
                                                </tr>
                                                <tr>
                                                    <td>Description:</td>
                                                    <td>
                                            ...
                                            <br />
                                            <input type="submit" name="add_event" value="Add" class="btn btn-sm btn-danger"> </form>
                                    </div>
                                    <br />
                                    <br /> </div>
