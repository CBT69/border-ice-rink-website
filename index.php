...
?>
    ...
    <head>
        <meta charset="utf-8">
        <title>Home-Border Ice Rink</title>
        ...
        <main class="shadow">
            <div id="midbar" class="row">
                ...
                <div id="rside" class="col-sm-8 col-md-9 col-lg-8 container-fluid">
                    <section>
                        <header>
                            <h1>Welcome to Border Ice Rink</h1> </header>
                        <main>
                            <h3>The Scottish Curling and Ice Skating Society</h3>
                            <br />
                            <div class="container-fluid image"> <img src="img/web/curling1.jpg" alt="curling man" class="img img-responsive img-rounded"> </div>
                        </main>
                    </section>
                </div>
                <!--End of Right panel-->
